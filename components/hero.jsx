    ...
    <section className="pt-40 pb-20 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="italic font-[Unna,serif] text-xl text-blue-900 mb-8 max-w-2xl mx-auto">
          Finnovate AI transforms the way you manage finances — with personalized
          insights, predictive analytics, and intelligent automation to help you
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a
            href="https://www.youtube.com/@vishwasjeetgupta8407"
            target="_blank"
          >
            <Button
              size="lg"
        ...
        {/* Clerk Sign-In button (hidden, used for modal trigger) */}
...
//           transition={{ duration: 2 }}
//         >
//           {text} {/* This will now display the typed text */}
//         </motion.h1>
